  ...
  return (
    <section className="relative py-24 sm:py-32 bg-ink-900 overflow-hidden">
      ...
      <div className="relative max-w-4xl mx-auto px-4 sm:px-6 text-center">
        {/* Pill badge */}
        <span className="inline-block px-4 py-1.5 rounded-full bg-white/10 text-white/70 text-xs font-bold uppercase tracking-wider mb-8 border-2 border-white/20 shadow-retro-white">
          {dict.cta.label}
        </span>

        {/* Massive heading */}
        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-white tracking-normal mb-6 leading-[1.15]">
