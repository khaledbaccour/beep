    ...
    <section className="relative bg-[#D8CCFF] pt-32 pb-0 sm:pt-40 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="flex flex-col items-center text-center">
          ...
          {/* MASSIVE headline */}
          <h1 className="animate-fade-up opacity-0 stagger-1 text-[36px] sm:text-[64px] lg:text-[96px] font-display font-bold uppercase leading-[0.95] tracking-[0.01em] text-ink-900">
            {dict.hero.headline}{' '}
