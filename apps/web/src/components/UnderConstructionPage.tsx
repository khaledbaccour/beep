...
const content: Record<Locale, { heading: string; subtitle: string; note: string }> = {
  ...
  ar: {
    heading: '\u0642\u064a\u062f \u0627\u0644\u0625\u0646\u0634\u0627\u0621',
    subtitle: '\u0646\u062d\u0646 \u0646\u0628\u0646\u064a \u0634\u064a\u0626\u064b\u0627 \u0645\u0630\u0647\u0644\u0627\u064b.',
    note: '\u062a\u0631\u0642\u0628\u0648\u0627 !',
  },
};
    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-cream-100 px-6 text-center">
      ...
      <div className="text-5xl mb-6 animate-bee-bob" aria-hidden="true">
        <svg width="64" height="64" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <ellipse cx="32" cy="36" rx="16" ry="14" fill="url(#stripes)" />
          ...
          <defs>
            <pattern id="stripes" x="0" y="0" width="64" height="8" patternUnits="userSpaceOnUse">
              <rect width="64" height="4" fill="transparent" />
            </pattern>
          </defs>
        </svg>
      </div>
